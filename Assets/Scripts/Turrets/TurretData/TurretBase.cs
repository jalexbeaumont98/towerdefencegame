...
public class TurretBase : MonoBehaviour
{
    ...
    [SerializeField] protected int tileSellPrice = 0;
    ...
    protected bool isWithinTargettingAngleRange = false, updateTarget = false;

    protected GameObject unitCircle, towerHighlight;
    ...
    protected void SpawnRangeCircle()
    {
    ...
    protected bool HasReachedMaximumUpgradesStandalone(int path)
    {
        if (path == 0)
        {
